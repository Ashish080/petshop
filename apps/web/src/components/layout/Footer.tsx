            ...
            <div className={themeConfig.spacing.container + " pt-16 pb-8"}>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-12 gap-10 xl:gap-16 mb-16">
                    ...
                    <div className="xl:col-span-2 space-y-6">
                        <div>
                            <h3 className="font-black text-text-primary uppercase tracking-[0.2em] text-[10px] mb-6">Logistics Fleet</h3>
                            <Link href="/rider/auth/signup" className="inline-flex items-center gap-2 text-xs font-black text-indigo-500 hover:text-indigo-600 transition-all uppercase tracking-widest bg-indigo-100/50 px-4 py-2 rounded-xl border border-indigo-200 shadow-sm">
                                Join as Rider 🛵
                            </Link>
                        </div>
                        <div>
                            <h3 className="font-black text-text-primary uppercase tracking-[0.2em] text-[10px] mb-6">Administration</h3>
                            <Link href="/admin/login" className="inline-flex items-center gap-2 text-xs font-black text-brand-primary hover:text-secondary transition-all uppercase tracking-widest bg-brand-primary/10 px-4 py-2 rounded-xl border border-brand-primary/20 shadow-sm">
                                Admin CP 🔐
                            </Link>
                        </div>
                    </div>
