            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-1.5 group">
                    <div className="flex justify-between items-end mb-0.5 px-1">
                        ...
                        <button onClick={handleForgotPassword} className="text-[10px] font-black text-indigo-600 uppercase tracking-widest hover:text-indigo-700 transition-colors">Forgot Key?</button>
                    </div>
                    <div className="relative">
                        ...
                        <input 
                            ...
                            required
                            placeholder="••••••••"
                            className="w-full pl-12 pr-12 py-4 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-bold text-slate-900 focus:outline-none focus:ring-4 focus:ring-indigo-500/5 focus:border-indigo-600 transition-all placeholder:text-slate-300"
